...
hi Comment      term=NONE cterm=NONE ctermfg=237  ctermbg=NONE
hi Constant     term=NONE cterm=NONE ctermfg=109  ctermbg=NONE
hi Cursor       term=NONE cterm=NONE ctermfg=69  ctermbg=NONE
...
hi Error        term=NONE cterm=NONE ctermfg=52  ctermbg=66
hi ErrorMsg     term=NONE cterm=NONE ctermfg=52   ctermbg=16
hi FoldColumn   term=NONE cterm=NONE ctermfg=238  ctermbg=NONE
hi Folded       term=NONE cterm=NONE ctermfg=238  ctermbg=NONE
hi Function     term=NONE cterm=NONE ctermfg=9    ctermbg=NONE
hi Identifier   term=NONE cterm=NONE ctermfg=52   ctermbg=NONE
...
hi Todo         term=NONE cterm=NONE ctermfg=52   ctermbg=NONE
hi Type         term=NONE cterm=NONE ctermfg=103  ctermbg=NONE
